...
$HTMLCode .= '    </body>
    ...
    $file_to_save = 'user/Factura_'.$Folio.'_'.$Cliente_Nombre.'.pdf';
    file_put_contents($file_to_save, $dompdf->output()); 
?>
    <blockquote>
    <p>Factura Folio<strong><?php echo $Folio;?></strong></p> <cite>Por $0.00, emitida para <?php echo $Cliente_Nombre;?> el <?php echo $FechaEmision;?></cite>
</blockquote>
<div class="panel panel-primary">
    <div class="panel-heading"> <h3 class="panel-title">Factura Generada </h3> </div>
    Para descargar en PDF haga click <a href="user/Factura_<?php echo $Folio;?>_<?php echo $Cliente_Nombre;?>.pdf" target="_blank">aqui.</a>
</div>
